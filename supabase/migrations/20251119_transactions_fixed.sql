...
-- FIXED: Handles existing transaction_type enum

-- 1) Enum for transaction type (skip if exists)
DO $$ BEGIN
...
-- 2) Main transactions table (drop and recreate to ensure clean state)
