-- ============================================================================
-- Create inventory_alias_links table (v2 - handles existing table)
-- ============================================================================
...
DROP TABLE IF EXISTS public.inventory_alias_links CASCADE;

-- Create inventory_alias_links table
CREATE TABLE public.inventory_alias_links (
...
CREATE INDEX idx_inventory_alias_links_inventory
  ON public.inventory_alias_links(inventory_id);

CREATE INDEX idx_inventory_alias_links_catalog
  ON public.inventory_alias_links(alias_catalog_id);

CREATE INDEX idx_inventory_alias_links_listing
  ON public.inventory_alias_links(alias_listing_id)
  WHERE alias_listing_id IS NOT NULL;

CREATE INDEX idx_inventory_alias_links_status
