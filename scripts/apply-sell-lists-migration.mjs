...
async function applyMigration() {
  console.log('\n🚀 Applying sell lists migration...\n');

  try {
    const sql = readFileSync('supabase/migrations/20251123_create_sell_lists.sql', 'utf-8');
    ...
    console.log('   File: supabase/migrations/20251123_create_sell_lists.sql\n');
    process.exit(1);
  }
}
